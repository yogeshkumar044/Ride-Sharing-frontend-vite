    ...
    <div>
        ...
        <div className='flex gap-4 justify-between flex-col items-center'>
            ...
            <div className='flex items-center justify-between gap-0 w-full'>
                ...
                }} className='w-full m-3 bg-green-600 text-white font-semibold p-2 rounded-lg '>Accept</button>
                <button onClick={()=>{
                    props.setRidePopupPanel(false);
                }} className='w-full m-3 bg-gray-400 text-gray-700 font-semibold p-2 rounded-lg '>Ignore</button>
            </div>

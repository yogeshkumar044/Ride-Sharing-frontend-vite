        ...
        <div className="p-4 bg-white shadow-lg rounded-lg">
            ...
            <div 
                ...
                <div className='ml-2 w-1/2'>
                    ...
                    <h5 className='font-medium text-sm'>{formatTime(props.fare[0])} away</h5>
                    <p className='font-normal text-xs text-gray-600'>Affordable, compact rides</p>
                </div>
                <h2 className='text-lg font-semibold'>₹{props.fare[1]?.car ?? "N/A"}</h2>
            </div>
            ...
            <div 
                ...
                <h2 className='text-lg font-semibold'>₹{props.fare[1]?.moto ?? "N/A"}</h2>
            </div>
            ...
            <div 
                ...
                <h2 className='text-lg font-semibold'>₹{props.fare[1]?.auto ?? "N/A"}</h2>
            </div>
        </div>
    );
};
